...
//    }
    ...
    public static class ApiWebSecurityConfigurationAdapter extends WebSecurityConfigurerAdapter {
        protected void configure(HttpSecurity http) throws Exception {
            http.antMatcher("/api/v10/i/**")// 带有“i”的目录都需要认证或提供token
...
//					.antMatchers("/api/create", "/", "/assets/**", "/plugins/**", "/static/**", "/bootstrap/**","/demo/**",
//							"/v2/api-docs/**", "/swagger-ui.html**", "/webjars/**", "/swagger-resources/**", "/api/**") // 免认证目录
//					.permitAll().antMatchers("/admin1/**").hasRole("ADMIN")// ADMIN角色可以访问/admin目录
