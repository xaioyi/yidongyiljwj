package com.sectong.authorization.interceptor;
...
/**
 * 自定义拦截器，判断此次请求是否有权限
 * @see com.sectong.authorization.annotation.Authorization
 * @author ScienJus
 * @date 2015/7/30.
 */
@Component
public class AuthorizationInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request,
        ...
        if(authorization!=null){
            String[] aa=null;
            aa=authorization.split(" ");
            if(aa.length>1)authorization1=aa[1];
            }
        TokenModel model = manager.getToken(authorization1);
